...
class _NoticeDetailState extends State<NoticeDetail> {
  ...
  _handleDetail() async {
    _detailMainCourse = await GqlCourseAPI.singleCourseInfo(
      variables: DetailMainCourseRequest(courseId: widget.product.courseId),
      context: context,
    );
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBarCommon(context: context, title: _focusData.title),
      body: ListView(
        children: <Widget>[
          // Container(
          ...
          //           // color: Colors.green,
          //           child: Text(
          //             TimeChange.client(_focusData.onlineTime, "ymd"),
          //             style: const TextStyle(
          //               fontFamily: 'MyFontStyle',
          //               color: Colors.black,
          //               fontSize: 14,
